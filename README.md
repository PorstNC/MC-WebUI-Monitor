...
将 文件夹下的 、 文件夹及 的游戏文件夹复制到 项目目录下。.minecraftassetslibraries1.21.8MC-WebUI-Monitor
注意：
...
按网页按钮操作并关注下方提示信息。
## 项目简介
启动游戏并通过ffmpeg.exe传输，快速MJPG流实现监视，已经不会出现刷新图片导致闪烁，给与无法监视Minecraft客户端的用户提供网页监视服务(非服务器端)
